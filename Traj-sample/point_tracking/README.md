...
```bash
python new_point_tracking.py --clustering_method bipartite --csv_path ./finesports.csv  --base_feat_path /home/mmlab206/61347023S/trokens/fine_output_dump --num_frames_clustering 4
```
